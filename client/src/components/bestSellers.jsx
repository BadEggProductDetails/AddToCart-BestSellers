      ...
      <div className="best-sellers">
        ...
        <ul className="sellers-list">
                  ...
                  <div className="store-fix">
                    <div className="item-seller">
                      ...
                      <p className="seller-list-rating">
                        <i className="rating">
                          <img
                            src={`${url.url}/assets/${this.configureRating(
                              items.reviewScore
                            )}`}
                            alt=""
                          />
                  ...
                  <div className="popover-body">
                    ...
                    <div className="market-text-view">
                      ...
                      <div className="market-text-view-count">
                        ...
                        <sup>
                          .{items.deliveryPcnt.toString().split(".")[1]}
                        </sup>
                    ...
                    <div className="market-text-view">
                      <div className="market-text-view-title">
                        CUSTOMER SERVICE{" "}
                      </div>
                      <div className="market-text-view-subtitle">
                        SATISFACTION{" "}
                      </div>
                      <div className="market-text-view-count">
          ...
          <li className="lowest-offer">
            <a href="#" className="lowest-offer-link">
              Compare Offers for as low as $95.77
            </a>
          </li>
        </ul>
      </div>
